...
Sentinel is a PHP 7.2.5+ framework agnostic fully-featured authentication & authorization system. It also provides additional features such as user roles and additional security features.
...
[icon-travis]:    https://travis-ci.org/cartalyst/sentinel.svg?branch=4.x
